...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Hero Content */}
      <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full text-white flex flex-col justify-center h-full animate-fade-in">
        ...
        <div className="flex flex-row items-center space-x-4 mb-8">
          <a
            href="#booking"
            className="flex-1 sm:flex-initial text-center bg-gold hover:bg-white text-primary font-sans text-[13px] sm:text-sm font-bold tracking-wider px-6 sm:px-8 py-3.5 sm:py-4 rounded-sm shadow-lg hover:text-primary transition-all duration-300 uppercase"
            id="hero-book-btn"
          >
            BOOK NOW
          </a>
          <button
            className="flex-1 sm:flex-initial flex items-center justify-center space-x-2 border border-white hover:border-gold hover:text-gold font-sans text-[13px] sm:text-sm font-bold tracking-wider px-5 sm:px-7 py-3.5 sm:py-4 rounded-sm transition-all duration-300 uppercase bg-transparent"
            id="hero-video-btn"
          >
