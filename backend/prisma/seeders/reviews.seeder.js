...
async function seedReviews(prisma, hotelId) {
    ...
    await Promise.all(data.reviewsData.reviews.map((review) => prisma.review.create({
        data: {
            hotelId: hotelId,
...
//# sourceMappingURL=reviews.seeder.js.map